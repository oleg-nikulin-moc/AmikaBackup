...
function swell_initialization() {
  ...
  $(document).on("swell:setup", function() {
    ...
    if($(".campaigns").length>0){
      ...
      // $(".campaigns .swell-campaign:last-child").after("<li class='swell-campaign swell-logo'> <div class='swell-campaign-content swell-buy-product-btn hide'> <div class='swell-logo'> <img src='//cdn.shopify.com/s/files/1/0550/7884/6672/t/10/assets/swell-logo.png?v=6260424389743728131621580271'> </div> </div> </li>");
